  ...
  if (images.length === 1) {
    return (
      <>
        <img
          role="presentation"
          src={`${backUrl}/upload/img_thumb/${images[0]}`}
          alt={images[0]}
          onClick={onZoom}
        />
    ...
    return (
      <div>
        ...
        <img
          role="presentation"
          width="50%"
          src={`${backUrl}/upload/img_thumb/${images[1]}`}
          alt={images[1]}
          onClick={onZoom}
        />
      </div>
